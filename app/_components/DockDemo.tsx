...
export function DockDemo() {
  return (
    <div className="relative">
      <Dock
        className="border-[#d19b75] border-3 border-dashed"
        direction="middle"
      >
        <DockIcon>
          <Link
        ...
        <DockIcon>
          <Link href={LINKS.gmail} className="flex items-center justify-center">
            <Icons.gmail className="size-6" />
          </Link>
        </DockIcon>
        <DockIcon>
          <Link href={LINKS.naver} className="flex items-center justify-center">
            <Icons.naver className="size-6" />
          </Link>
        </DockIcon>
      </Dock>
    </div>
